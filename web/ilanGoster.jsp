                                    ...
                                    try{
                                        ...
                                        for (int i = 0; i < db.ilanlariCek(dirid).size(); i++) {
                                            out.print("<div class=\"row\">" +
                                                    "<div class=\"col-xs-7\" style =\" margin-top: 7px \">" + db.ilanlariCek(dirid).get(i).getIlanadi() + "</div>" +
                                                    "<div class=\"col-xs-3\" style =\" \"><a href=\"ilanDetay.jsp?id=" + db.ilanlariCek(dirid).get(i).getIlanid() + "\"><button type=\"button\" class=\"form-control btn btn-ilanlar\">Görüntüle</button></a></div>" +
                                                    "</div>");
                                        }
                                    }
                                    catch (Exception e ){
